...
function Forecast(props?: any) {
    ...
    return (
        <Container maxWidth="xl" className='forecast'> {/*'here we printout whe weatherforecast with icons to list component Here is also textfield.'*/}
            ...
            <Typography variant="body2">You can search with key word only once per 3 minutes. This is free api service. Time from last search<strong> {(searchTime / 60000).toFixed(2)} min</strong></Typography>
