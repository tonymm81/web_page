...
const StartPage: React.FC<Props> = (props: Props): React.ReactElement => {
  ...
  return (
    ...
    <Container className='start_image' >
      ...
      <Dialog open={openDialog} ><Typography variant="body1" sx={{ margin: "5px" }} >This is the web page. Demo page. Page wont save anything to local store except token and route. There is Forecast
      ...
      <Dialog open={props.captcha}><Typography variant="body1" sx={{ margin: "5px" }} >Hello. I have this site 2 different free api services. Sorry but i have to test
