...
apiWorkTimeRouter.put("/employeedata/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (yield prisma.employee_data.count({
        ...
        if (((_a = req.body.description) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            try {
...
apiWorkTimeRouter.post("/employerdata", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (((_a = req.body.employee_name) === null || _a === void 0 ? void 0 : _a.length) > 0) {
        try {
            ...
            next(new errorHalndler_1.ServerError(400, "database error" + e));
        }
    }
    else {
...
apiWorkTimeRouter.put("/employerdata/:id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let checkState = yield prisma.employee_data.findFirst({ where: { employee_id_auto: Number(req.params.id) } });
        console.log("are we tying to change state", checkState === null || checkState === void 0 ? void 0 : checkState.IsHoursAccepted);
        yield prisma.employee_data.update({
            where: {
                employee_id_auto: Number(req.params.id)
            },
            data: {
                datetime_emp: checkState === null || checkState === void 0 ? void 0 : checkState.datetime_emp,
                hours_employee: checkState === null || checkState === void 0 ? void 0 : checkState.hours_employee,
                description: checkState === null || checkState === void 0 ? void 0 : checkState.description,
                jobID: checkState === null || checkState === void 0 ? void 0 : checkState.jobID,
                IsHoursAccepted: !(checkState === null || checkState === void 0 ? void 0 : checkState.IsHoursAccepted)
            }
        });
        let employerdata = yield get_employer_data_needed(); // get all employer data
        res.json({ employerdata });
        ...
        next(new errorHalndler_1.ServerError(400, "database error" + errors));
    }
}));
