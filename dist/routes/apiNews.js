...
const check_search_time = (what_time_news) => {
    ...
    if (search_permission[0]) {
        if (Number(req.query.userchoose) === 0) {
            ...
            try {
                ...
                next(new errorHalndler_1.ServerError(400, `Not find data for this search word from everything ${e}`));
            }
        }
        if (Number(req.query.userchoose) === 1) {
            ...
            try {
                ...
                next(new errorHalndler_1.ServerError(400, `Not find data for this search word from top news ${e}`));
            }
        }
    }
    else {
